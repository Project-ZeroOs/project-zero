...
class TestStage2FFPermissions(unittest.TestCase):
    ...
    def test_qemu_stage2ff_telemetry(self):
        ...
        markers = [
            ...
            ".multiboot_header: [0xFFFFFFFF80100000, 0xFFFFFFFF80101000) (R + NX)",
            ".text:             [0xFFFFFFFF80101000, 0xFFFFFFFF8014A000) (RX)",
            ".rodata:           [0xFFFFFFFF8014A000, 0xFFFFFFFF8015C000) (R + NX)",
            ".data:             [0xFFFFFFFF8015C000, 0xFFFFFFFF80163000) (RW + NX)",
            ".bss:              [0xFFFFFFFF80163000, 0xFFFFFFFF80169000) (RW + NX)",
            ".pmm_metadata:     [0xFFFFFFFF80169000, 0xFFFFFFFF8016D000) (RW + NX)",
            ".page_tables:      [0xFFFFFFFF8016D000, 0xFFFFFFFF80171000) (RW + NX)",
            ".stack_guard:      [0xFFFFFFFF80171000, 0xFFFFFFFF80172000) (NOT PRESENT)",
            ".stack:            [0xFFFFFFFF80172000, 0xFFFFFFFF80182000) (RW + NX)",
            "Kernel Size Bound:           0xFFFFFFFF80182000 <= 0xFFFFFFFF80200000 (<= 2 MiB window) [VERIFIED]",
            "Populated 4 KiB kernel_pt:   129 active 4 KiB pages mapped with granular permissions",
